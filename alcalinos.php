...
<body>
    ...
    <h1 style="margin-top: 20px; font-size: 3em; text-align: center; color: #666666;">INVENTARIO DE ÁLCALINOS</h1>
    <div class="container">
        <?php
        ...
        $productosNombres = array(
            "S10" => "S10-CAUSTI FOAM CL",
            "S11" => "S11-CAUSTI LC200",
            "S14" => "S14-HIPOCLORITO 13%",
            "S20" => "S20-SOSA LIQUIDA 50%",
            "S24" => "S24-LCC ALKA",
