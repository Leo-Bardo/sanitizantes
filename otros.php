...
<body>
    ...
    <h1 style="margin-top: 20px; font-size: 3em; text-align: center; color: #666666;">INVENTARIO DE OTROS</h1>
    <div class="container">
        <?php
        ...
        $productosNombres = array(
            "S05" => "S05-ALCOHOL ETILICO",
            "S27" => "S27-AGUA DESTILADA",
            "S28" => "S28-THINNER",
            "S32" => "S32-GLICOL",
            "S33" => "S33-GEL TROLL GEL",
