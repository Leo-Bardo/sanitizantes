...
<body>
    ...
    <h1 style="margin-top: 20px; font-size: 3em; text-align: center; color: #666666;">INVENTARIO DE PEROXIDO</h1>
    <div class="container">
        <?php
        ...
        $productosNombres = array(
           "S23" => "S23-PEROXIDO BATH",
           "S26" => "S26-PER WASH",
           "S23B"=>"S23B-PEROXIDO IPS",
