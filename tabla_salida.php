...
// Consulta base para obtener las salidas del producto específico
$consulta = "SELECT *, ROW_NUMBER() OVER (ORDER BY idSalida) AS numeroFila 
             FROM salida 
...
// Consulta para obtener la suma total de la cantidad de salidas
$consulta_suma = "SELECT SUM(cantidadSalida) AS totalSalidas 
                  FROM salida 
                  WHERE producto = '$producto'";
...
$total_salidas = mysqli_fetch_assoc($resultado_suma)['totalSalidas'];

// Estructura HTML para la tabla de salidas
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Tabla de Salidas de <?php echo htmlspecialchars($producto); ?></title>
...
<body>
    ...
    <div class="botones-container">
        <a href="entrada.html" id="btn-registrar-nuevo" class="boton">Registrar Nuevo</a>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong><?php echo $total_salidas; ?></strong></td>
                    <td></td>
                </tr>
            </tbody>
        </table>
